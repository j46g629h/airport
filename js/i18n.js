...
const I18N = {
  id: {
    ...
    'home.query.desc':  'Untuk semua karyawan dan keluarga — tanpa akun, tanpa kata sandi.',
    'home.query.p1':    'Cari dengan email: jadwal Anda sendiri, plus keluarga yang memakai email yang sama.',
    'home.query.p2':    'Cari dengan tanggal atau nomor penerbangan: siapa saja yang satu pesawat dengan Anda.',
    'home.query.p3':    'Yang tampil: tanggal, jam keluar dari PCI, titik jemput, dan nomor penerbangan.',
    ...
    'edit.date':        'Tanggal pesawat',
    'edit.arah':        'Jemput / Antar',
    'edit.pciHint':     'Berangkat hari yang sama tulis 20:00. Berangkat sehari sebelumnya tulis 30/08 20:00 (tanggal dulu, baru bulan).',
    'edit.sec.vehicle': 'Kendaraan',
    'edit.sec.person':  'Data orang (jarang diubah)',
    'edit.personHint':  'Data ini disalin saat jadwal dibuat. Mengubahnya di sini tidak mengubah DAFTAR PERSONEL — perbaiki hanya kalau ada salah ketik.',
    'edit.name':        'Nama',
    'edit.namaCina':    'Nama Cina',
    'edit.save':        'Simpan',
    'edit.cancel':      'Batal',
    'edit.delete':      'Hapus',
    'edit.saved':       'Tersimpan.',
    'edit.savedMoved':  'Tersimpan. Baris dipindah: {s}',
    'edit.deleted':     'Data sudah dihapus.',
    'edit.confirmDelete': 'Hapus data ini?\n\n{s}\n\nTidak bisa dibatalkan.',
    'edit.err.gone':    'Data ini sudah tidak ada. Silakan muat ulang.',
    'edit.err.required':'Ada kolom wajib yang kosong.',
    'edit.err.date':    'Tanggal tidak valid.',
    'edit.err.status':  'Pilihan status / jemput-antar tidak dikenal.',
    'edit.err.busy':    'Sedang ada proses lain. Coba lagi sebentar.',
    ...
    'adm.err.idle':     'Tidak ada aktivitas selama {n} menit. Silakan login kembali.',
    'adm.msg.idleOut':  'Anda keluar otomatis karena tidak ada aktivitas. Silakan login kembali.',
    'adm.msg.expiredOut': 'Sesi Anda sudah berakhir. Silakan login kembali.',
    'idle.warn':        'Keluar otomatis dalam {n} menit jika tidak ada aktivitas.',
    ...
    'list.custom':      'Rentang sendiri',
    'list.stat.todo':   'Perlu ditangani',
    'list.overdueAll':  '⚠ {n} lewat tanggal belum ditangani (semua periode)',
    'list.range.all':   'Semua',
  ...
  zh: {
    ...
    'home.query.desc':  '給全體同仁與眷屬使用——不需要帳號，也不需要密碼。',
    ...
    'edit.date':        '航班日期',
    'edit.arah':        '接／送',
    'edit.pciHint':     '航班當天出車寫 20:00；前一天出車寫 30/08 20:00（日在前、月在後）。',
    'edit.sec.vehicle': '派車',
    'edit.sec.person':  '人員資料（很少改）',
    'edit.personHint':  '這一區是新增當下複製過來的。在這裡改不會動到人員名冊，打錯字才需要改。',
    'edit.name':        '姓名',
    'edit.namaCina':    '中文名字',
    'edit.save':        '儲存',
    'edit.cancel':      '取消',
    'edit.delete':      '刪除',
    'edit.saved':       '已儲存。',
    'edit.savedMoved':  '已儲存。這一筆搬到了：{s}',
    'edit.deleted':     '已刪除。',
    'edit.confirmDelete': '要刪除這一筆嗎？\n\n{s}\n\n這個動作無法復原。',
    'edit.err.gone':    '這一筆已經不存在了，請重新整理。',
    'edit.err.required':'有必填欄位是空的。',
    'edit.err.date':    '日期不正確。',
    'edit.err.status':  '狀態或接／送的選項認不得。',
    'edit.err.busy':    '另一個作業正在進行中，請稍後再試。',
    ...
    'adm.err.idle':     '閒置超過 {n} 分鐘，已自動登出，請重新登入。',
    'adm.msg.idleOut':  '因為閒置太久已自動登出，請重新登入。',
    'adm.msg.expiredOut': '登入已過期，請重新登入。',
    'idle.warn':        '再 {n} 分鐘沒有操作就會自動登出。',
    'idle.stay':        '繼續使用',
    ...
    'acc.new.emailNotifHint':'帳號不是電子郵件時必填——忘記密碼的臨時密碼會寄到這裡。',
    'acc.act.reset':    '重設密碼',
    'acc.act.disable':  '停用',
    'acc.act.enable':   '啟用',
    ...
    'list.custom':      '自訂區間',
    'list.stat.todo':   '待處理',
    'list.overdueAll':  '⚠ 逾期未處理 {n} 筆（全部期間）',
    'list.range.all':   '全部',
    'list.quick.week':  '本週',
